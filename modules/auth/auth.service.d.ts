...
export declare class AuthService {
    ...
    validateUser(email: string, password: string): Promise<import("mongoose").Document<unknown, any, UserDocument> & UserDocument & {
    ...
    register(user: any): Promise<{
        user: Pick<import("mongoose").Document<unknown, any, UserDocument> & UserDocument & {
            _id: import("mongoose").Types.ObjectId;
